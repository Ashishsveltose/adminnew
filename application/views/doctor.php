...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>home/assets/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>home/assets/css/select2.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>home/assets/css/bootstrap-datetimepicker.min.css">
        ...
        <div class="header">
            <div class="header-left">
                <a href="index.html" class="logo">
                    <img src="<?php echo base_url();?>home/assets/img/md_logo.png" width="35" height="35" alt=""> <span>XpressCure Admin</span>
                </a>
            </div>
                            ...
                            <ul class="notification-list">
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media">
                                            <span class="avatar">
                                                <img alt="John Doe" src="<?php echo base_url();?>home/assets/img/user.jpg" class="img-fluid">
                                            </span>
...
include('sidebar.php')
    ...
    <script src="<?php echo base_url();?>home/assets/js/jquery.dataTables.min.js"></script>
    <script src="<?php echo base_url();?>home/assets/js/dataTables.bootstrap4.min.js"></script>
