...
include('sidebar.php');
        ...
        <div class="page-wrapper">
            ...
            <a href="https://ezheal.in/new_medical/addbanner" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Add Banner</a>
            
                    <div class="col-lg-6">
                        <div class="card-box">
                            <div class="card-block">
                                <h4 class="card-title">Banner Tables</h4>
