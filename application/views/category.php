...
?>
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form method="post">
                            <div class="row">
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Specialztion <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="specialztion"placeholder="">
                                    </div>
                                    </div>
                                    <div class="col-sm-6">
                                    <div class="form-group">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn">Add Category</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script src="<?php echo base_url();?>admin/home/assets/js/jquery.slimscroll.js"></script>
    <script src="<?php echo base_url();?>admin/home/assets/js/select2.min.js"></script>
	<script src="<?php echo base_url();?>admin/home/assets/js/moment.min.js"></script>
	<script src="<?php echo base_url();?>admin/home/assets/js/bootstrap-datetimepicker.min.js"></script>
