...
include('sidebar.php');
        ...
        <div class="page-wrapper">
            ...
            <a href="https://ezheal.in/admin/customers" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Add Customer</a>
            
                    <div class="col-lg-12">
                        <div class="card-box" style="margin-top:50px;">
                            <div class="card-block">
                                <h4 class="card-title">Customers Tables</h4>
              ...
              <tbody>
                ...
                <?php $count = 1; 
                  if(!empty($customer_list)){
                    foreach ($customer_list as $getdata) { 
                  ?>
                    <tr>
                      ...
                      <td><?php  echo (!empty($getdata['age'])?$getdata['age']:'none'); ?></td>
                      ...
                      <td>
                        <a href="<?php echo base_url() ?>/new_medical/unit/<?php echo  $getdata['user_id']; ?>" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 

                        <?php if($getdata['status'] == 0){ ?>
                          <a href="javascript:void(0)" href-data="<?php echo  $getdata['user_id']; ?>" class="useractive" title="Change status"><i class="fa fa-toggle-off" aria-hidden="true"></i></a>
                        <?php } if($getdata['status'] == 1){?>
                          <a href="javascript:void(0)" href-data="<?php echo  $getdata['user_id']; ?>" class="deactive" title="Change status"><i class="fa fa-toggle-on" aria-hidden="true"></i></a>
                        <?php } ?>
                          <a href="javascript:void(0)" href-data="<?php echo  $getdata['user_id']; ?>" class="delete" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                      </td> 
  ...
  $(".delete").click(function(e){
    ...
    if(val){
      $.ajax({
        ...
        data:{table:'customers',id:id,status:3,colwhr:'user_id',whrstatuscol:'status',action:"Delete"},
        dataType:'json',
      ...
      window.location.reload();
        ...
        if(val){
            $.ajax({
              ...
              data:{tablename:'customers',id:id,status:0,whrcol:'user_id',whrstatuscol:'status',action:"Deactive"},
              dataType:'json',
              success: function(response) {
                if (response.status == 1){
  ...
  $(".useractive").click(function(e){
    ...
    if(val){
      $.ajax({
        type: "POST",
        url: "<?php echo base_url();?>admin/welcome/change_status",
        data:{tablename:'customers',id:id,status:1,whrcol:'user_id',whrstatuscol:'status',action:"Active"},
        dataType:'json',
        success: function(response) {
          if (response.status == 1){
            $.notify(response.msg, "success");
