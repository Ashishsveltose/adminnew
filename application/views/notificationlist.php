...
include('sidebar.php');
        ...
        <div class="page-wrapper">
            ...
            <a href="https://ezheal.in/admin/notification" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Add Notification</a>
            
                    <div class="col-lg-12">
                        <div class="card-box" style="margin-top:50px;">
                            <div class="card-block">
                                <h4 class="card-title">Notification Tables</h4>
              ...
              <tbody>
                ...
                <?php $count = 1; 
                  if(!empty($notificationlist)){
                    foreach ($notificationlist as $getdata) { 
                  ?>
                    <tr>
...
$(document).ready(function(){
  ...
  $(".delete").click(function(e){
    var val = confirm("Are you sure, you want to delete notification ?");
    if (val == true){
    ...
    if(val){
      $.ajax({
        ...
        data:{table:'notification',id:id,status:3,colwhr:'id',whrstatuscol:'status',action:"Delete"},
        dataType:'json',
  ...
  $(".deactive").click(function(e){
        var val = confirm("Are you sure, you want to deactivate notification ?");
        if (val == true){
      window.location.reload();
    }
      ...
      window.location.reload();
        ...
        if(val){
            $.ajax({
              ...
              data:{tablename:'notification',id:id,status:0,whrcol:'id',whrstatuscol:'status',action:"Deactive"},
              dataType:'json',
              success: function(response) {
                if (response.status == 1){
  ...
  $(".useractive").click(function(e){
    var val = confirm("Are you, sure you want to activate notification ?");
    if (val == true){
      window.location.reload();
    }
    ...
    if(val){
      $.ajax({
        type: "POST",
        url: "<?php echo base_url();?>admin/welcome/change_status",
        data:{tablename:'notification',id:id,status:1,whrcol:'id',whrstatuscol:'status',action:"Active"},
        dataType:'json',
        success: function(response) {
          if (response.status == 1){
            $.notify(response.msg, "success");
