...
<div class="content-wrapper">
  ...
  <section class="content-header"><h1>Polls <small>List</small></h1></section>
  <!-- Main content -->
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header col-md-6" style="float: left;">
            <h3 class="box-title">
                <a href="<?php echo base_url();?>adminnew/addarea" class="btn btn-primary pull-right">Add Polls</a>
            </h3>
          </div>
                ...
                <?php $count = 1; 
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url() ?>adminnew/addarea/<?php echo  $getdata['area_id']; ?>" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
...
<script type="text/javascript">
  ...
  $(".delete").click(function(e){
    var val = confirm("Sure you want to Delete Poll ?");
  ...
  $(".deactive").click(function(e){
        var val = confirm("Sure you want to Deaactive Poll ?");
        //e.preventDefault(); 
        var id = $(this).attr("href-data");
        //alert(href);
        //var btn = this;
  ...
  $(".activearea").click(function(e){
    var val = confirm("Sure you want to active Poll ?");
    var id = $(this).attr("href-data");
    if(val){
      $.ajax({
        type: "POST",
