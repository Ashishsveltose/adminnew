...
include('sidebar.php');
        ...
        <div class="page-wrapper">
            ...
            <a href="https://ezheal.in/admin/addtax" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Add Tax</a>
            
                    <div class="col-lg-12">
                        <div class="card-box" style="margin-top:50px;">
                            <div class="card-block">
                                <h4 class="card-title">Tax Tables</h4>
                ...
                <?php $count = 1; 
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php  echo (!empty($getdata['percentage'])?$getdata['percentage']:'none'); ?></td>
...
$(document).ready(function(){
  ...
  $(".delete").click(function(e){
    var val = confirm("Are you sure, you want to delete tax ?");
    if (val == true){
    ...
    if(val){
      $.ajax({
        ...
        data:{table:'tax',id:id,status:3,colwhr:'id',whrstatuscol:'status',action:"Delete"},
        dataType:'json',
  ...
  $(".deactive").click(function(e){
        var val = confirm("Are you sure, you want to deactivate tax ?");
        if (val == true){
      window.location.reload();
    }
        ...
        if(val){
            $.ajax({
              ...
              data:{tablename:'tax',id:id,status:0,whrcol:'id',whrstatuscol:'status',action:"Deactive"},
              dataType:'json',
              success: function(response) {
                if (response.status == 1){
                  $.notify(response.msg, "success");
  ...
  $(".useractive").click(function(e){
    var val = confirm("Are you, sure you want to activate tax ?");
    if (val == true){
      window.location.reload();
    }
    ...
    if(val){
      $.ajax({
        type: "POST",
        url: "<?php echo base_url();?>admin/welcome/change_status",
        data:{tablename:'tax',id:id,status:1,whrcol:'id',whrstatuscol:'status',action:"Active"},
        dataType:'json',
        success: function(response) {
          if (response.status == 1){
            $.notify(response.msg, "success");
