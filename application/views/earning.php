                    ...
                    <div class="col-lg-12">
                        <div class="card-box" style="margin-top:50px;">
                            <div class="card-block">
                                <h4 class="card-title">Cinician earning</h4>
              ...
              <tbody>
                ...
                <?php $count = 1; 
                  if(!empty($earninglist)){
                    foreach ($earninglist as $getdata) { 
                  ?>
                    <tr>
                      <td><?php echo $count; ?></td>
                      <td><?php  echo (!empty($getdata['usertype'])?$getdata['usertype']:'none'); ?></td>
                      <td><?php  echo (!empty($getdata['usename'])?$getdata['usename']:'none'); ?></td>
                      <td><?php  echo (!empty($getdata['paient_name'])?$getdata['paient_name']:'none'); ?></td>
...
$(document).ready(function(){
  ...
  $(".delete").click(function(e){
    var val = confirm("Are you sure, you want to delete Cinician earning ?");
    if (val == true){
    ...
    if(val){
      $.ajax({
        ...
        data:{table:'earning',id:id,status:3,colwhr:'id',whrstatuscol:'status',action:"Delete"},
        dataType:'json',
