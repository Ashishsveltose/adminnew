                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="name"placeholder="enter tax name">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="percentage" placeholder="enter tax percentage">
                                </div>
                             </div>
                             <!--   <div class="col-sm-6">
                                    <div class="form-group">
