...
<body>
        ...
        <div class="header">
            <div class="header-left">
                <a href="index.html" class="logo">
                    <img src="assets/img/md_logo.png" width="35" height="35" alt=""> <span>XpressCure Admin</span>
                </a>
            </div>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="doctors.html"><i class="fa fa-stethoscope"></i> <span>Doctors</span></a>
                        </li>
                        <li>
    ...
    <!-- USE COMMON HEADER FOOTER JS CLOSE-->
</body>
