...
<body>
        ...
        <div class="header">
            <div class="header-left">
                <a href="index.html" class="logo">
                    <img src="home/assets/img/md_logo.png" width="35" height="35" alt=""> <span>XpressCure Admin</span>
                </a>
            </div>
                            ...
                            <ul class="notification-list">
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media">
                                            <span class="avatar">
                                                <img alt="John Doe" src="home/assets/img/user.jpg" class="img-fluid">
                                            </span>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="doctors.php"><i class="fa fa-stethoscope"></i> <span>Doctors</span></a>
                        </li>
                        <li>
                            <a href="doctormitra.html"><i class="fa fa-user-md"></i> <span>Doctor Mitra </span></a>
                        </li>
                        <li>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fa fa-commenting-o"></i> <span> Marketing</span> <span class="menu-arrow"></span></a>
                            <ul style="display: none;">
                            	<li><a href="#">The X post</a></li>
                            	<li><a href="#">Xpress World</a></li>
                            	<li><a href="#">Medical Dictionary</a></li>
                            	<li><a href="#">Health Books</a></li>
                                <li><a href="#">Inspirational Stories</a></li>
                                <li><a href="#">The X Channel</a></li>
                                <li><a href="#">The X Channel</a></li>
                                <li><a href="#">X Post Subscriptions</a></li>
                                <li><a href="#">Health Informatics</a></li>
                                <li><a href="blog.html">The Cure Blog</a></li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i><span>Pharmacy</span></a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-plus-square" aria-hidden="true"></i><span>Lab</span></a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-check-square-o" aria-hidden="true"></i><span>Control Panel</span></a>
                        </li>
                        
                        <li class="submenu">
                            <a href="#"><i class="fa fa-star-half-o" aria-hidden="true"></i><span> Reviews and Ratings </span> <span class="menu-arrow"></span></a>
                            <ul style="display: none;">
                                <li><a href="doctor_rating.html"> Doctor  </a></li>
                                <li><a href="#"> Doctor Mitra </a></li>
                                <li><a href="#"> Doctor App </a></li>
                                <li><a href="#"> Doctor Mitra App </a></li>
                            </ul>
                        </li>
    ...
    <script src="home/assets/js/jquery.slimscroll.js"></script>
    <script src="home/assets/js/Chart.bundle.js"></script>
    <script src="home/assets/js/chart.js"></script>
