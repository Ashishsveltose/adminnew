...
<head>
        ...
        <link rel="apple-touch-icon" href="<?=base_url();?>home/bapple-touch-icon.html">
        <!-- Place favicon.ico in the root directory -->
        <link rel="stylesheet" href="<?= base_url('home/css/vendor.css');?>">
        ...
        <script>
            ...
            if (themeName)
            {
                document.write('<link rel="stylesheet" id="theme-style" href="<?=base_url();?>home/css/app-' + themeName + '.css">');
            }
            else
            {
                document.write('<link rel="stylesheet" id="theme-style" href="<?=base_url();?>home/css/app.css">');
            }
        </script>
    </head>
    <body>
